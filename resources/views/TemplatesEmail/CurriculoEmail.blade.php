@foreach ($dadosUser as $ItemBd)

<!doctype html>
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">

<head>
  <title> {{ $ItemBd->name }} - Curriculo </title>
  <!--[if !mso]><!-->
...
<body style="word-spacing:normal;background-color:#E7E7E7;">
  ...
  <div style="background-color:#E7E7E7;">
    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#003366;background-color:#003366;width:100%;">
      <tbody>
        <tr>
          <td>
            <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;" width="600" bgcolor="#003366" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
                          ...
                          <tbody>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td style="width:150px;">
                                        <img alt height="auto" src="https://i.imgur.com/phWJhUh.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="150">
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                            ...
                            <tr>
                              <td align="center" style="font-size:0px;padding:10px 25px;padding-top:0;word-break:break-word;">
                                <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:13px;font-weight:bold;letter-spacing:1px;line-height:20px;text-align:center;text-transform:uppercase;color:#E0E6F6;">
                                  {{ $ItemBd->codtecno }}
                                  {{-- Laravel, inertia.js e vue.js --}}
                                </div>
                              </td>
                            </tr>
                            <tr>
                                    ...
                                    <tr>
                                      <td style="width:600px;">
                                        <a href="https://www.linkedin.com/in/marcellohenrique-pro/" target="_blank">
                                          <img alt="fullstack" height="auto" src="https://i.imgur.com/OJf0Rc9.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600">
                                        </a>
                                      </td>
                                    </tr>
                                  </tbody>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                          <tbody>
                            <tr>
                              <td style="width:600px;">
                                <a href="https://www.linkedin.com/in/marcellohenrique-pro/" target="_blank">
                                  <img alt height="auto" src="https://i.imgur.com/ctuZYbt.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600">
                                </a>
                              </td>
                            </tr>
                          </tbody>
                            ...
                            <tbody>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:17px;font-weight:bold;line-height:24px;text-align:left;color:#212b35;">Prezado(a) membro da equipe de recrutamento,</div>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#424C60;">Olá! Gostaria de me apresentar como um desenvolvedor Full Stack Júnior com experiência em análise de sistemas e assistência em informática avançada. Estou entrando em contato para expressar meu interesse na oportunidade de contribuir como membro da equipe de desenvolvimento. <br><br> Minha paixão pela tecnologia e minha busca constante por aprendizado me permitiram explorar diversas áreas, desde a manutenção de computadores até o desenvolvimento de sistemas web. Como desenvolvedor Full Stack, tenho experiência tanto no desenvolvimento de front-end quanto no back-end, utilizando frameworks como Laravel e Vue.js. <br><br>
                                    <strong> Aqui está um resumo das minhas habilidades:</strong>
                                    <br><br>
                                    <li style="padding-bottom: 10px"> Programação lógica e desenvolvimento de front-end. </li>
                                    <li style="padding-bottom:10px"> Desenvolvimento de back-end utilizando PHP e Laravel. </li>
                                    <li style="padding-bottom:10px"> Linguagens de programação como PHP, JavaScript e C#. </li>
                                    <li style="padding-bottom:10px"> Conhecimento de frameworks como Vue.js e Bootstrap. </li>
                                    <li style="padding-bottom:10px"> Domínio de bancos de dados como MySQL e ferramentas como o PhpMyAdmin. </li>
                                    <li style="padding-bottom:10px"> Experiência com controle de versão utilizando o Git. </li>
                                    <li style="padding-bottom: 20px"> Práticas de programação orientada a objetos (POO). </li> Além das habilidades técnicas, também possuo habilidades em trabalho em equipe, comunicação interpessoal e gestão de serviços de atendimento ao cliente. Estou comprometido em entregar soluções de alta qualidade e estou constantemente buscando aprimorar minhas habilidades. <br><br> Acredito que minha experiência e competências se alinham bem com as necessidades da sua empresa. Estou animado com a oportunidade de contribuir para projetos desafiadores e colaborar com uma equipe talentosa. <br><br>
                                    <strong>Anexo a este e-mail</strong>, você encontrará meu <strong>currículo</strong> detalhado, que fornece mais informações sobre minha experiência e formação acadêmica. <br><br> Agradeço antecipadamente pela consideração e fico à disposição para qualquer esclarecimento adicional.
                                  </div>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:17px;font-weight:bold;line-height:24px;text-align:left;color:#212b35;">Atenciosamente,<br> {{ $ItemBd->name }} <br> {{ $ItemBd->whatsapp }}<br> {{ $ItemBd->email }} <br></div>
                                </td>
                              </tr>
                              <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:12px;font-weight:400;line-height:24px;text-align:center;color:#424C60;">Obs: Este modelo de email foi criado por mim utilizando o framework <a href="https://mjml.io/" target="_blank" style="color:#424C60">mjml</a></div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                                ...
                                <td style="vertical-align:top;padding:0;">
                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" style width="100%">
                                    <tbody>
                                      ...
                                      <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                          <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:11px;font-weight:bold;line-height:24px;text-align:center;color:#445566;">Você pode acessar minhas redes sociais</div>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                          <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:11px;font-weight:400;line-height:16px;text-align:center;color:#445566;">Este email foi enviado para sua empresa devido ao anucio por busca de proficionais talentosos e dedicados, espero que esse email possa ajudar a encotrar o que procura.</div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
